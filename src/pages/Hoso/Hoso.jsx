...
function createData(id, Mahoso, Nganhxettuyen, Tohopxettuyen, Tongdiem, city, action) {
  return {
    id,
    Mahoso,
    Nganhxettuyen,
...
const rows = [
  createData(1, 'HS01', 'Công Nghệ Thông Tin','A00', '25.6', 'Bà Rịa - Vũng Tàu'),
  createData(2, 'HS02', 'Công Nghệ Thông Tin','A01', '26.7', 'Bà Rịa - Vũng Tàu'),
  createData(3, 'HS03', 'Sư Phạm Văn','D01', '24.2', 'Bà Rịa - Vũng Tàu'),
  createData(4, 'HS04', 'Sư Phạm Toán','A00', '22.6', 'Bà Rịa - Vũng Tàu'),
  createData(5, 'HS05', 'Sư Phạm Lý','A01', '27.5', 'Bà Rịa - Vũng Tàu'),
  createData(6, 'HS06', 'Sư Phạm Hóa','A00', '21.8', 'Bà Rịa - Vũng Tàu'),
  createData(7, 'HS07', 'Sư Phạm Toán','A01', '20.5', 'Bà Rịa - Vũng Tàu'),
    ...
    >
      ...
      {numSelected > 0 ? (
        ...
        <>
          ...
          component="div"
          >
          <h2 >Danh sách hồ sơ xét duyệt</h2>
          <Toolbar>
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">{row.Nganhxettuyen}</TableCell>
                    <TableCell align="left">{row.Tohopxettuyen}</TableCell>
