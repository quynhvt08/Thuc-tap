    ...
    try {
      ...
      setRows(prevRows => {
        const updatedRows = [...prevRows, newEntry].map(item => {
          ...
          } else if (item.type === 'xa') {
            return { ...item, type: 'Xã' };
          } else if (item.type === 'thi-tran') {
            return { ...item, type: 'Thị trấn' };
          } else if (item.type === 'tinh') {
            return { ...item, type: 'Tỉnh' };
          } else if (item.type === 'quan') {
    ...
    >
      <>
        <Typography
          ...
          component="div"
        >      
          <h2> <CottageOutlinedIcon /> &nbsp;&nbsp;Danh sách Phường/Xã</h2>
        </Typography>
        <FormGroup sx={{ mr : 5 }}>
          <FormControl >
            <TextField
      ...
      <React.Fragment>
        ...
        <Dialog open={open} onClose={handleClose}>
          <DialogTitle>Thêm mới 1 Phường/Xã</DialogTitle>
          <DialogContent>
            <DialogContentText>
    ...
    if (selectedProvince) {
      ...
      if (selectedDistrict) {
        ...
        if (selectedWard) {
          ...
          filteredRows = rows.filter(row => filteredWards.some(ward => ward.code === row.code));
        }
      } else {
                ...
                <Card>
                  <CardContent>
                    <Stack spacing={2} direction="column">
                      <h3><CottageOutlinedIcon /> &nbsp;&nbsp;Lọc theo Khu vực </h3>
                    ...
                    <TableRow hover tabIndex={-1} key={row.id}>
                      ...
                      <TableCell align="left" sx={{ width : '20%' }}>
                        ...
                        <Dialog open={openEditDialog} onClose={handleCloseEditDialog}>
                          <DialogTitle>Cập nhật thông tin Phường/Xã</DialogTitle>
                          <DialogContent>
                            <DialogContentText>
